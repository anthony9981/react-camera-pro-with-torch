...
var Camera = React.forwardRef(function (_a, ref) {
    ...
    var _p = useState(false), isTorchOn = _p[0], setTorchOnOff = _p[1];
    useEffect(function () {
    ...
    useEffect(function () {
        initCameraStream(stream, setStream, currentFacingMode, videoSourceDeviceId, setNumberOfCameras, setNotSupported, setPermissionDenied, setTorchSupported, setTorchOnOff);
...
var initCameraStream = function (stream, setStream, currentFacingMode, videoSourceDeviceId, setNumberOfCameras, setNotSupported, setPermissionDenied, setTorchSupported, setTorchOnOff) {
    var _a;
...
function checkTorchExists(device, stream) {
    return __awaiter(this, void 0, void 0, function () {
        var supportedConstraints, track, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    supportedConstraints = device === null || device === void 0 ? void 0 : device.getSupportedConstraints();
                    track = stream.getTracks()[0];
                    if (!(supportedConstraints && 'torch' in supportedConstraints && track && track.applyConstraints)) return [3 /*break*/, 5];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
